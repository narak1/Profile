...
namespace TestClient
{
	class Packet
	{
		public enum Cmd { Add, Del, Read, Write, Save, Load, Remove };
		static string[] strCmd = { "Add", "Del", "Read", "Write", "Save", "Load", "Remove" };
		...
		public byte[] encode()
		{
			...
			foreach (Argument arg in this.m_arglist)
			{
				Buffer.BlockCopy(arg.encode(), 0, mesg, idx, arg.m_length);
				idx += arg.m_length;
			}
